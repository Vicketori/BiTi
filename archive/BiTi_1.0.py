...
class Ui_Game(object):
    def setupUi(self, Game):
        ...
        def main_menu():
            ...
            i_start_btn_mm = QIcon()
            i_start_btn_mm.addPixmap(QPixmap("design/start_mm.png"))
            self.start_btn_mm.setIcon(i_start_btn_mm)
            ...
            i_skins_btn_mm = QIcon()
            i_skins_btn_mm.addPixmap(QPixmap("design/skins_mm.png"))
            self.skins_btn_mm.setIcon(i_skins_btn_mm)
            ...
            i_quit_btn_mm = QIcon()
            i_quit_btn_mm.addPixmap(QPixmap("design/quit_mm.png"))
            self.quit_btn_mm.setIcon(i_quit_btn_mm)
            ...
            i_settings_btn_mm = QIcon()
            i_settings_btn_mm.addPixmap(QPixmap("design/settings_mm.png"))
            self.settings_btn_mm.setIcon(i_settings_btn_mm)
        ...
        def lvl():
            ...
            i_goto_slcm_lvl = QIcon()
            i_goto_slcm_lvl.addPixmap(QPixmap("design/goto_slcm_lvl.png"))
