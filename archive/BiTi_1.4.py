...
class Game_(object):
    def setupUi(self, Game):
        ...
        """настройки слайдер"""
        # сохранять значение в txt
        # a = 0.5
        # self.effect.setVolume(a)
        # self.effect.play()
        ...
        self.music_bg_field_down_slcm = PushButton("design/slcm/music_field.png", "design/slcm/music_field_selected.png", 950, 195, self.slcm)
        HCursor(self.music_bg_field_down_slcm)
        self.music_bg_field_down_slcm.setStyleSheet("QPushButton {border-radius: 40px}")
        self.music_bg_field_down_slcm.setGeometry(1000, 525, 950, 195)

        self.music_bg_field_up_slcm = PushButton("design/slcm/music_field.png", "design/slcm/music_field_selected.png", 950, 195, self.slcm)
        HCursor(self.music_bg_field_up_slcm)
        self.music_bg_field_up_slcm.setStyleSheet("QPushButton {border-radius: 40px}")
        self.music_bg_field_up_slcm.setGeometry(1000, 75, 950, 195)

        self.music_field_central_slcm = PushButton("design/slcm/music_central_field.png", "design/slcm/music_central_field_selected.png", 1026, 195, self.slcm)
        HCursor(self.music_field_central_slcm)
        self.music_field_central_slcm.setStyleSheet("QPushButton {border-radius: 40px}")
        self.music_field_central_slcm.setGeometry(894, 300, 1026, 195)

        self.goto = PushButton("design/goto_mm.png","design/goto_mm_selected.png", 760, 121, self.slcm)
        HCursor(self.goto)
        BRadius(self.goto)
