...
class Game(QMainWindow):
    ...
    def sm_lvl(self):
        ...
        self.lc_6.setPixmap(QPixmap("design/skins/" + skin + "/circle.png"))
        self.lc_7.setPixmap(QPixmap("design/skins/" + skin + "/circle.png"))
        self.lc_8.setPixmap(QPixmap("design/skins/" + skin + "/circle.png"))
        self.lc_9.setPixmap(QPixmap("design/skins/" + skin + "/circle.png"))
        self.lc_0.setPixmap(QPixmap("design/skins/" + skin + "/circle.png"))
